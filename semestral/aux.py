...
def calcula_preco_inicial_carteira(carteira, lista_ativos_semestre):
    return calcula_cotacoes_carteira(carteira, lista_ativos_semestre)[0]

def calcula_preco_final_carteira(carteira, lista_ativos_semestre):
